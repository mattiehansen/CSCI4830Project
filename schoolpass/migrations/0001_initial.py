# Generated by Django 2.0.6 on 2018-08-07 19:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_number', models.PositiveSmallIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(9999)])),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='pass',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schoolpass.Student'),
        ),
        migrations.AddField(
            model_name='pass',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schoolpass.Teacher'),
        ),
    ]
